...
var ptransform = require('parallel-transform')
...
module.exports = function (opts) {
  ...
  lvlDb.get('!last_block!', function (err, lastBlock) {
    ...
    state.startBlock = state.currentBlock = state.processed = lastBlock ? Number(lastBlock) + 1 : 0
    trackSyncing()
  ...
  function processChanges (start) {
    ...
    feed
      ...
      .pipe(ptransform(10, processChange))
      .pipe(through2.obj(recordLastBlock))
